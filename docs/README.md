...
These pages define the tracked evidence, catalog, and workflow contracts. The
...
- [Unit definitions](unit-definitions.md) - recovered unit type IDs, base combat stats, and shared AI consumers.
...
- [Comments and prose](ai_agents/comments-and-prose.md) - tracked writing policy.
